...
- [pbi](https://github.com/mittelmark/pbi) - package for the course Practical Bioinformatics at the University of Potsdam
- [sbi](https://github.com/mittelmark/sbi) - package for the courses Statistical Bioinformatics and Machine Learning in Bioinformatics at the University of Potsdam
- [snha](https://github.com/mittelmark/snha) - Implementation of St. Nicolas House Analysis in R to create correlation networks for interacting variables, see [Groth et al. 2019](https://doi.org/10.1127/anthranz/2019/1027) and [Hermanussen et al. 2021](https://doi.org/10.3390/ijerph18041741)
- [tmdoc4r](https://github.com/mittelmark/tmdoc4r) - package for reproducibe research, embed R, Python, Octave, GraphViz etc code in your Markdown documents, used in the courses Statistical Bioinformatics, Practical Bioinformatics and Machine Learning in Bioinformatics at the University of Potsdam
- [trachy](https://github.com/mittelmark/trachy) - package for analysis of Trachypithecus species microbiome data for the paper "Molecular genetic characterization of the diet of limestone and rainforest langurs" by Truong et al. (in preparation)
